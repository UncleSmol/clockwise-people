              ...
              <form action={formAction} className="grid gap-2">
                ...
                <label className="grid gap-1">
                  ...
                  <span className="flex items-start gap-2 rounded-lg border border-border bg-background px-3 pt-2.5">
                    ...
                    <textarea name="review_notes" rows={2} className="min-w-0 flex-1 bg-transparent text-sm text-foreground outline-none resize-none" placeholder="Optional review note" />
                  </span>
                </label>
