    ...
    <div className="flex items-center gap-2">
      ...
      <div className="md:hidden">
        ...
        <aside
          ...
          className={`fixed bottom-0 right-0 top-0 z-50 w-[min(84vw,340px)] border-l border-border bg-surface shadow-2xl transition-transform duration-300 ease-out ${
          ...
          <div className="flex h-full flex-col">
            <div className="flex items-center justify-between gap-4 border-b border-border px-5 py-4">
              ...
              <button
                ...
                className="grid size-9 shrink-0 place-items-center rounded-md border border-border bg-surface-muted text-foreground"
              >
