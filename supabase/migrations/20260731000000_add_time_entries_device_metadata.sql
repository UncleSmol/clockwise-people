-- Add device_metadata to time_entries (the clock RPC stores enriched
-- geofence metadata there) and restore the refresh_time_entry_calculations
-- call that was dropped when record_employee_time_event was rewritten.
